...
public class OrderServiceTest {
	...
	public void placeOrder_basic() throws OrderException {
		...
		.thenReturn(new Order(orderRequest.getCustomerId(), OrderStatus.INITIATED, orderRequest.getRestaurantId()));
	...
	public void cancelOrder_basic() {
		Optional<Order> order = Optional.of(new Order(1L, OrderStatus.INITIATED, 2L));
		Order placedOrder = new Order();
		placedOrder.setCustomerId(1L);
		placedOrder.setId(1L);
		placedOrder.setStatus(OrderStatus.DENIED);
	...
	public void updateOrder_quantityLess() throws OrderException {
		Optional<Order> order = Optional.of(new Order(1L, OrderStatus.INITIATED, 1L));
	...
	public void updateOrder_basic() throws OrderException {
		Order orderReturned = new Order(1L, OrderStatus.INITIATED, 1L);
